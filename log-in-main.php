            ...
            <div class="login-form">
                <div class="sign-in-htm">
                    <div class="group">
                        ...
                        <input name="username" id="user" type="text" class="input" placeholder="Enter Username">
                    </div>
                    <div class="group">
                        <label for="pass" class="label">Password</label>
                        <input name="password" id="pass" type="password" class="input" data-type="password" placeholder="Enter Password">
                    </div>
                    <div class="group">
                ...
                <div class="sign-up-htm">
                    ...
                    <div class="group">
                        ...
                        <input id="pass" type="text" class="input" placeholder="Enter Email">
                    </div>
                    <div class="group">
